<%@ page language="java"  import="subjectSystem.student" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<br>
<input type="button" value="查看个人信息" onclick="javascript:location.href='stuInf.action?studentID=<%=newstudent.getStudentID() %>'"> 
<br>
<input type="button" value="选课" onclick="javascript:location.href='chooseSub.action?studentID=<%=newstudent.getStudentID() %>'"> 
<br>
<input type="button" value="查询课表" onclick="javascript:location.href='searchChooseSub.action?studentID=<%=newstudent.getStudentID() %>'"> 
<br>
<input type="button" value="查询成绩" onclick="javascript:location.href='searchChooseGrade.action?studentID=<%=newstudent.getStudentID() %>'"> 
<br>
