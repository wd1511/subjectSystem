<%@ page language="java"  import="subjectSystem.teacher,java.util.*,subjectSystem.subject" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	 ...
	 <section id="intro" class="intro">
		...
		<div class="container-fluid">
			<div class="row-fluid">
<%teacher a = (teacher)request.getAttribute("newTea");%>
教师<%=a.getTeacherID() %>-<%=a.getTeacherName() %>是否确认删除？
<br>
<input type="button" value="确认" onclick="javascript:location.href='maDelTea1.action?teacherID=<%=a.getTeacherID()%>'"> 
