...
<body>
	 ...
	 <section id="intro" class="intro">
		...
		<div class="container-fluid">
			<div class="row-fluid">
<%student a = (student)request.getAttribute("newStu");%>
学生<%=a.getStudentID() %>-<%=a.getStudentName() %>是否确认删除？
<br>
<input type="button" value="确认" onclick="javascript:location.href='maDelStu1.action?studentID=<%=a.getStudentID()%>'"> 
