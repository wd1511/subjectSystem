...
<% for(int i=0;i<allSub.size();i++){ %>
	<%= allSub.get(i).getSubjectID() %> ;<%=mes.get(i) %>
	<input type="button" value="退课" onclick="javascript:location.href='searchChooseSub1.action?studentID=<%=newstudent.getStudentID() +";"+allSub.get(i).getSubjectID() %>'"> 
	<br>
<%} %>
