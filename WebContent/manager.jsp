...
管理员先生您好。
<br>
<input type="button" value="查询老师信息" onclick="javascript:location.href='maTea.action'"> 
<br>
<input type="button" value="查询学生信息" onclick="javascript:location.href='maStu.action'"> 
<br>
<input type="button" value="添加学生" onclick="javascript:location.href='addStu.action'"> 
<br>
<input type="button" value="添加老师" onclick="javascript:location.href='addTea.action'"> 
