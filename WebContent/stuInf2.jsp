...
<form action = "stuInf3.action?studentID=<%=a.getStudentID() %>" method = "post">
输入旧密码：<%=" " %>:<input type = "password" name = "oldPa"><br>
输入新密码：<%=" " %>:<input type = "password" name = "newPa"><br>
确认旧密码：<%=" " %>:<input type = "password" name = "newPa1"><br>
<input type = "submit" value = "修改密码">
<input type="button" value="返回" onclick="javascript:location.href='stuInf4.action?studentID=<%=a.getStudentID() %>'"> 
</form>
</div>
		</div>
	</div>
