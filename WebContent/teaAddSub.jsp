<%@ page language="java" 
	import="subjectSystem.student,subjectSystem.teacher,java.util.*,subjectSystem.subject"
...
你好，<%=newteacher.getTeacherID() %>-<%=newteacher.getTeacherName() %>>
<br>
	<h2>请输入课程信息</h2>
			<form action = "teaAddSub1.action?n=<%=newteacher.getTeacherID() %>" method = "post">
			课程编号<%=" " %>:<input type = "text" name = "subID"><br>
			课程名称<%=" " %>:<input type = "text" name = "name"><br>
			课程容量<%=" " %>:<input type = "text" name = "capacity"><br>
